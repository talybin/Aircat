...
public class Job2 extends ListenerBase<Job2.Listener> {
    ...
    public interface Listener {
        void onJobStateChange(Job2 job);
        void onHashCatProgressChange(Job2 job, HashCat.Progress progress);
    }
