...
public class HashCat2 extends Thread {
    ...
    // Constructor
    HashCat2(@NonNull Context context, @NonNull Job job, @Nullable Listener listener) {
        super();
    ...
    // Constructor
    public HashCat2(@NonNull Context context, @NonNull Job job) {
